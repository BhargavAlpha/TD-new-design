    ...
    <div className="edu-container">
      <div className="project-item-parent">
        <div className="project-item">
          <h3 className="projects1">Education</h3>
        </div>
        <button className="project-actions" onClick={addEducation}>
      ...
      {education.length > 0 ? (
        education.map((edu, index) => (
          <section key={index} className="frame-group">
            ...
            <div className="edit-parent" onClick={() => editEducation(edu)}>
        ...
        <div className="no-sec">No education data available</div>
      )}
