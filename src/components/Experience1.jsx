    ...
    <div className="proj-container">
      <div className="project-item-parent">
        <div className="project-item">
          <h3 className="projects1">Work Experience</h3>
        </div>
        <button className="project-actions" onClick={addExperience}>
        ...
        return (
          <section key={index} className="project-details">
            <div className="project-name-parent">
              ...
              <div className="edit-group" onClick={() => editExperience(experience)}>
            ...
            <div className="proj-points-container">
              <ul className="proj-points">
                {experience.description.map((desc, i) => (
                  <li key={i} className="lorem-ipsum-dolor1">{desc}</li>
                ))}
              </ul>
            </div>
            <div className="proj-tech-container">
              {skillsArray.map((skill, i) => (
                <button key={i} className="proj-tech-btn">
                  <div className="proj-tech">{skill}</div>
                </button>
              ))}
            </div>
          </section>
